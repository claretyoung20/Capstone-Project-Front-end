...
import {
    CURRENTADMINROLE, MANAGERROLE, ORDERCOUPONDIALOG,
...
export class OrderReportComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.getSumCompleteOrder();
        this.getCountCompleteOrder();
        this.getCountCancelOrder();
        this.getSumCancelOrder();
    }

    getSumCompleteOrder() {
        this.orderService.getSumCompleteOrder().subscribe( res => {
           this.sumCom = res;
        })
    }

    getCountCompleteOrder() {
        this.orderService.getCountCompleteOrder().subscribe( res => {
           this.countCom = res;
        })
    }

    getCountCancelOrder() {
        this.orderService.getCountCancelOrder().subscribe( res => {
           this.countCan = res;
        })
    }

    getSumCancelOrder() {
        this.orderService.getSumCancelOrder().subscribe( res => {
            this.sumCan = res;
        })
    }
    ...
    getAllOrder() {
        ...
        this.orderService.getOrderReport(query).subscribe(res => {
